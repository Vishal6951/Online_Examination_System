<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Examination_System.login" %>
...
<body class="bg-dark">
    ...
    <div class="container" style="margin-top: 8%; margin-left: 19%;">
        <div class="card card-login loginstyling mx-auto mt-5">
            <center>
                <div class="card-header" style="border-color: #00986F; border-width: 3px;">
                    <center>
            ...
            <div class="card-body">
                <form runat="server" id="formlogin">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txt_email" runat="server" CssClass="form-control emailbox" placeholder="Enter email" TextMode="Email" BackColor="#1D2026" BorderColor="#00986F" BorderStyle="Solid" BorderWidth="3px" ForeColor="White"></asp:TextBox>
