<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.Master" AutoEventWireup="true" CodeBehind="addquestion.aspx.cs" Inherits="Examination_System.Admin.addquestion" %>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row form-group">
                    <label class="col-md-2 col-form-label ">Question Name</label>
                    <div class="col-md-9">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RequiredFieldValidator ID="require_op1" runat="server" ErrorMessage="Please enter answer" ControlToValidate="txt_optionone" ForeColor="red"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RequiredFieldValidator ID="require_op2" runat="server" ErrorMessage="Please enter answer" ControlToValidate="txt_optiontwo" ForeColor="red"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RequiredFieldValidator ID="require_op3" runat="server" ErrorMessage="Please enter answer" ControlToValidate="txt_optionthree" ForeColor="red"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <asp:RequiredFieldValidator ID="require_op4" runat="server" ErrorMessage="Please enter answer" ControlToValidate="txt_optionfour" ForeColor="red"></asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="row form-group">
