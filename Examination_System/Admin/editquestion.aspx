<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.Master" AutoEventWireup="true" CodeBehind="editquestion.aspx.cs" Inherits="Examination_System.Admin.editquestion" %>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <label class="col-md-2 col-form-label text-center">Correct Answer</label>
                    <div class="col-md-4">
                        <asp:RadioButtonList ID="rdo_editcorrectanswer" runat="server" RepeatDirection="Horizontal" RepeatLayout="Table" CellPadding="10" Width="250px">
