...
<body class="bg-dark">
    ...
    <div class="container" style="margin-top: 10%; margin-left: 19%;">
        <div class="card card-register adminregisterstyling mx-auto mt-5">
            <center>
            ...
            <div class="card-body">
                <form runat="server" id="formregister">
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col">
                                ...
                                <asp:TextBox ID="txt_adminame" runat="server" CssClass="form-control" placeholder="Enter a name" BackColor="#1D2026" BorderColor="#00986F" BorderStyle="Solid" BorderWidth="3px" ForeColor="White"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txt_adminemail" runat="server" CssClass="form-control" placeholder="Enter email" TextMode="Email" BackColor="#1D2026" BorderColor="#00986F" BorderStyle="Solid" BorderWidth="3px" ForeColor="White"></asp:TextBox>
                    ...
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-6">
                                ...
                                <asp:TextBox ID="txt_adminpass" runat="server" CssClass="form-control" placeholder="Enter password" TextMode="Password" BackColor="#1D2026" BorderColor="#00986F" BorderStyle="Solid" BorderWidth="3px" ForeColor="White"></asp:TextBox>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Password must contain: Minimum 8 Characters atleast 1 Uppercase Alphabet, 1 Lowercase Alphabet, 1 Number and 1 Special Character." ValidationExpression="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?%&]{8,}" ControlToValidate="txt_adminpass"></asp:RegularExpressionValidator>
